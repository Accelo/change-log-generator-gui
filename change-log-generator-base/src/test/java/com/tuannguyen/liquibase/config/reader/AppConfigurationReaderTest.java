...
public class AppConfigurationReaderTest
{
	...
	@Test
	public void getConfiguration_givenPromptMode_shouldUseInputConfigReader()
	...
	@Test
	public void getConfiguration_givenNoPromptMode_shouldUsePropertyLoader()
			throws InstantiationException, IllegalAccessException, IOException
	{
	...
	@Test
	public void getConfiguration_givenNoPromptModeButRequireConfiguration_shouldUsePropertyLoader()
			throws InstantiationException, IllegalAccessException, IOException
	{

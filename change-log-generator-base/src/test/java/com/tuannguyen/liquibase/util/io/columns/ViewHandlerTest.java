...
public class ViewHandlerTest
{
	...
	public void process_givenNoAfterColumn_shouldWriteToTheEnd() throws IOException
	{
		ViewHandler viewHandler =
				new ViewHandler(configuration, configuration.getChangeConfigurationList().get(2), templateHelper,
						xmlHelper, prospectFile);
		viewHandler.process();
	...
	{
		ViewHandler viewHandler =
				new ViewHandler(configuration, configuration.getChangeConfigurationList().get(1), templateHelper,
						xmlHelper, prospectFile);
		viewHandler.process();
		List<String> allLines = readLines(prospectFile);
	...
	{
		ViewHandler viewHandler =
				new ViewHandler(configuration, configuration.getChangeConfigurationList().get(0), templateHelper,
						xmlHelper, prospectFile);
		viewHandler.process();
		List<String> allLines = readLines(prospectFile);
	...
	{
		ViewHandler viewHandler =
				new ViewHandler(configuration, configuration.getChangeConfigurationList().get(3), templateHelper,
						xmlHelper, prospectFile);
		viewHandler.process();
		List<String> allLines = readLines(prospectFile);
	...
	{
		ViewHandler viewHandler =
				new ViewHandler(configuration, configuration.getChangeConfigurationList().get(4), templateHelper,
						xmlHelper, prospectFile);
		viewHandler.process();
		List<String> allLines = readLines(prospectFile);
